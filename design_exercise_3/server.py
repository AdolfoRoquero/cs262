...
class ChatAppServicer(chat_app_pb2_grpc.ChatAppServicer):
    ...
    def Login(self, request, context):
        ...
        if self.is_primary:
            ...
            return chat_app_pb2.RequestReply(reply = 'rerouted',
    ...
    def DeleteUser(self, request, context):
        ...
        if self.is_primary:
            if request.username in self._get_registered_users():
                ...
                return chat_app_pb2.RequestReply(reply="failed",
                                                 request_status=chat_app_pb2.FAILED)
        else: 
    ...
    def ReceiveMessage(self, request, context):
        ...
        if self.is_primary:
            ...
            return chat_app_pb2.RequestReply(request_status=chat_app_pb2.REROUTED,
                                             rerouted=self.primary_server_id)
